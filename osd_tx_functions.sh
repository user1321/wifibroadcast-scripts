...
function osdtx_function {
    ...
    while true; do
        ...
        nice cat $FC_TELEMETRY_SERIALPORT | nice /home/pi/cameracontrol/RCParseCh $ChannelToListen $ChannelToListen2 | nice /home/pi/wifibroadcast-base/tx_telemetry -p 1 -c $TELEMETRY_CTS -r 2 -x $TELEMETRY_TYPE -d 12 -y 0 $NICS
